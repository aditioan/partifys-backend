...
const DeletePartyHandler = require('./Commands/DeleteParty/Handler')
...
const CheckCodeValidator = require('./Commands/JoinParty/validators/CheckCode')
  ...
  const handlers = [
    ...
    new ValidatorDecorator(
      new ValidatorDecorator(
        ...
        new CheckCodeValidator(partyRepository)
      ),
